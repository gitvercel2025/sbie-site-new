          ...
          <div className={`space-y-8 transition-all duration-1000 ${
            ...
            <div className="space-y-6">
              ...
              <p className="text-xl sm:text-2xl text-sbie-forest-green leading-relaxed">
                Transforme sua carreira e seus relacionamentos. A SBIE oferece as ferramentas e o conhecimento 
                para você assumir o controle da sua vida e alcançar resultados.
              </p>
            </div>

            {/* Mission Statement */}
            <div className={`bg-white/60 backdrop-blur-sm rounded-2xl p-8 border border-sbie-bronze/20 shadow-xl transition-all duration-1000 delay-300 ${
              isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
            }`}>
              <div className="space-y-4">
                <h3 className="text-lg font-semibold text-sbie-dark-green mb-3">Missão:</h3>
                <blockquote className="text-sbie-dark-green/90 italic text-lg leading-relaxed">
                  "Multiplicar todo o meu conhecimento, formando novos Mentores que aplicam minha metodologia 
                  em todo o mundo, alcançando, transformando e impactando milhares de vidas ao redor do globo 
              ...
              <div className="relative bg-gradient-to-br from-white to-sbie-beige/50 rounded-3xl p-8 shadow-2xl border border-sbie-bronze/20">
                <div className="aspect-[4/5] bg-gradient-to-br from-sbie-beige to-sbie-sage/30 rounded-2xl flex items-center justify-center relative overflow-hidden">
                  ...
                  <div className="text-center text-sbie-dark-green/60">
                    <div className="w-32 h-32 bg-sbie-bronze/20 rounded-full mx-auto mb-4 flex items-center justify-center">
                      <svg className="w-16 h-16 text-sbie-bronze" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"/>
                      </svg>
                    </div>
                    <p className="text-lg font-medium">Rodrigo Fonseca</p>
                    <p className="text-sm opacity-75">Fundador e Presidente da SBIE</p>
                  </div>
                ...
                <div className="mt-6 text-center">
                  <h4 className="text-xl font-bold text-sbie-dark-green">Rodrigo Fonseca</h4>
                  <p className="text-sbie-forest-green">Fundador e Presidente da SBIE</p>
                </div>
              </div>
            </div>
          </div>
